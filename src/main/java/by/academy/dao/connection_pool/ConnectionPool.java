...
public class ConnectionPool {
    ...
    public ConnectionPool() {
        DBConfigLoader loader = DBConfigLoader.getInstance();
        this.driverName = loader.getValue(DBParameter.DB_DRIVER);
        this.url = loader.getValue(DBParameter.DB_URL);
        this.user = loader.getValue(DBParameter.DB_USER);
        this.password = loader.getValue(DBParameter.DB_PASSWORD);
        this.poolSize = Integer.parseInt(loader.getValue(DBParameter.DB_POLL_SIZE));
    }
    ...
    public void initPoolData() throws SQLException {
        try {
            ...
            throw new SQLException("Can't find database driver class", e);
        }
    }
