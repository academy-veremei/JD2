...
public class RegistrationInfo implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        return (firstName == rInfo.firstName || (firstName != null && firstName.equals(rInfo.firstName)))
                && (lastName == rInfo.lastName || (lastName != null && lastName.equals(rInfo.lastName)))
                && (email == rInfo.email || (email != null && email.equals(rInfo.email)))
                && (login == rInfo.login || (login != null && login.equals(rInfo.login)))
                && (password == rInfo.password || (password != null && password.equals(rInfo.password)));
    }
